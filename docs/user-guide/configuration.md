...
| `response_format` | String | `"text"`, `"json-object"`, or `"json-schema"` (note: Anthropic direct API only supports `"json-schema"`; [not available on Vertex AI](https://platform.claude.com/docs/en/build-with-claude/overview)) | `"text"` |
